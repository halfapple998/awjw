...
def init(context):
    ...
    context.symbol = 'DCE.p2105'                                 # 订阅交易标的 CZCE.MA105 DCE.p2105
...
def on_bar(context, bars):
    ...
    if (short_avg[-1] < bars[-1]['close']) and (long_avg[-1] > short_avg[-1]):
        # 无多仓情况下，直接开空
...
if __name__ == '__main__':
    '''
        ...
        '''
    run(strategy_id='2e15ca3b-7f12-11eb-a7fa-bc307def78f9',
        filename='main.py',
        mode=MODE_BACKTEST,
